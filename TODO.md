...
Build initial attack plan loop (fixed 4-iteration cycle). Keep this simple and deterministic for v0 rather than fully adaptive. The goal is to demonstrate the concept, not build a perfect search system.
